# flake8: noqa
"""
Django settings for xtrm project.
...
WSGI_APPLICATION = 'xtrm.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///xtrm'),
}
...
WAGTAIL_SITE_NAME = "XTRMsolution"
